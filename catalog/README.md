...
- `reference-designs/reference-designs.seed.json` contains starter metadata for open robotics design candidates plus optional backend/frontend handoff hints.
