...
- Validate catalog changes with `python3 scripts/validate_catalog.py`; run `python3 -m unittest discover tests` and the local catalog smoke path with `python3 tests/smoke_test.py`.
